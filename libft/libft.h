...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/19 15:09:10 by vaisha            #+#    #+#             */
/*   Updated: 2019/04/23 20:40:48 by vaisha           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_memcmp(const void *buf1, const void *buf2,
		size_t count);
...
char				*ft_strncat(char *destination, const char
		*append, size_t n);
